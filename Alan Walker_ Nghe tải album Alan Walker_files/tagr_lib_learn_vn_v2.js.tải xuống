function gmtagr()
{
	...
	this.gmScriptName = 'tagr_lib_learn_vn_v2.js'; // This parameter needs to match the name of the JS file *as saved to the CDN*
	this.trackingDomain = 'sg-gmtdmp.gd2.mookie1.com'; // Use the tracking domain from the TAGr tag generated in the UI
    this.acid = 32; // Use the account ID (acid) from the tag generated in the UI
...
{   
    ...
    gmRequest.src = gmtagr.prt+'//'+gmtagr.trackingDomain+'/tagr/v1/learn?acid='+gmtagr.acid+'&inst='+gmtagr.inst+'&tagid='+gmtagr.tagid+'&src.domain='+gmtagr.page.pD+'&src.url='+gmtagr.page.pP+'&'+srcParams+'&src.rand='+gmtagr.rand;
...
gmparams.src.id = ( gmURLParams.hasOwnProperty('id') ) ? gmURLParams['id']:'1';
gmparams.tagid = ( gmURLParams.hasOwnProperty('tagid') ) ? gmURLParams['tagid']:'1';
